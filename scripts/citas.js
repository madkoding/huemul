...
//
// Commands:
//   hubot una cita - Retorna una cita inspiracional
//
// Author:
//   @jorgeepunan
...
const quotes = [
  ...
  {
    quote: 'Cada niño es un artista. El problema es cómo seguir siendo artista una vez que se crece.',
    author: 'Pablo Picasso'
  },
  {
    quote: 'Nunca se puede cruzar el océano hasta que tenga el coraje de perder de vista la costa.',
  ...
  {
    quote: 'Los dos días más importantes en su vida son los días que se nace y el día que se descubre por qué.',
    author: 'Mark Twain'
  },
  {
    quote: 'Lo que puedas hacer o soñar, ponte a hacerlo. La osadía está llena de genialidad, poder y magia.',
    author: 'Johann Wolfgang von Goethe'
  },
  { quote: 'La mejor venganza es el éxito masivo.', author: 'Frank Sinatra' },
  {
    quote:
      'La gente suele decir que la motivación no dura mucho. Bueno, tampoco lo hace la ducha -por eso la recomendamos a diario.',
    author: 'Zig Ziglar'
  },
  ...
  {
    quote: 'Su tiempo es limitado, así que no lo desperdicien viviendo la vida de otra persona.',
    author: 'Steve Jobs'
  },
  { quote: 'Esfuérzate por no ser un éxito, sino más bien para ser de valor.', author: 'Albert Einstein' },
  {
    quote: 'Dos caminos se bifurcaban en un bosque, y yo tomé el menos transitado, y eso ha hecho toda la diferencia.',
    author: 'Robert Frost'
  },
  { quote: 'Si lo puedes soñar, lo puedes hacer.', author: 'Walt Disney' },
  {
    quote:
      'He fallado más de 9000 tiros en mi carrera. He perdido casi 300 juegos. He fallado una y otra y otra vez en mi vida. Y es por eso que tengo éxito.',
  ...
  {
    quote:
      'Dentro de veinte años estarás más decepcionado por las cosas que no hiciste que por las que hiciste, así que suelta las amarras, vela lejos del puerto seguro y captura de los vientos alisios en tus velas. Explora, Sueña y descubre.',
    author: 'Mark Twain'
  },
